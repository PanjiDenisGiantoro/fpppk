                                    ...
                                    <div class="box-body">
                                        <ul class="list">
                                            <li class="d-flex no-seen">
                                                <div class="img-mess"><img class="mr-14"
                                                                           src="assets_backend/images/avatar/avt-1.png"
                                                                           alt="avt"></div>
                                                <div class="info">
                                                    <a href="#" class="font-w600 mb-0 color-primary">Elizabeth
                                                        Holland</a>
                                                    <p class="pb-0 mb-0 line-h14 mt-6">Proin ac quam et lectus
                                                        vestibulum</p>
                                                </div>
                                            </li>
                                ...
                                <div class="box">
                                    <div class="box-header">
                                        <div class="me-auto">
                                            ...
                                            <p class="fs-18 mb-0 mt-6"><span class="text-primary pr-7">+3.2</span>than
                                                last week</p>
                                        </div>
                                    </div>
                                    <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="mb-3">
                                        <label class="form-label mb-14">Apakah ada memiliki Nomor Registrasi Anggota
                                            ?</label>
                                ...
                                <div class="emptydata">
                                    <div class="box-body">
                                        <div class="box-title">
                                            <h5 class="fs-30">Lengkapi Data Anda</h5>
                                        </div>
                                        <hr>
                                        <div class="auth-content my-auto">
                                            <form class="mt-6 pt-2" id="myForm"
                                                ...
                                                <div class="mb-3  mt-24">
                                                    ...
                                                    <input id="max_id" type="hidden" name="MAX_FILE_SIZE"
                                                           value="250000000"/>
                                                    <input id="max_id" type="hidden" name="MAX_FILE_SIZE"
                                                           value="250000000"/>

                                                    <input type="file" class="position-absolute form-control"
                                                           name="foto" id="inputImageFile" required
                                                           accept="image/*" style="opacity:0"
                                                           onchange="changeFileInput(this)">
                                                    <div id="fileView" class="form-control form-control-lg"
                                                         style="color:#A8A8A8; background-color:#E7E7E7; font-size:1rem;">
                                                        Unggah Gambar
                                                    </div>
                                                    <script>
                                                ...
                                                <ul class="list-inline mb-0">
                                                    ...
                                                    <li class="list-inline-item">
                                                        <a href="javascript:void()"
                                                           class="social-list-item  text-white">
    ...
    <script>
        ...
        $('#adas').on('change', function () {
            if ($(this).val() == '1') {
                $('.nranumber').show();
                $('.emptydata').hide();
                $('#btnCheckNra').attr('disabled', false);

            } else {
                $('#btnCheckNra').attr('disabled', true);
                $('#nra').val('');
                $('.nranumber').hide();
                $('.emptydata').show();
                // $('#btnCheckNra').hide();
